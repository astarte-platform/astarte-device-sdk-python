...
## [0.14.0] - 2025-06-25
### Added
- Support for `astarte-message-hub-proto` version `0.8.0`.
- Renamed send APIs:
  - Property interface: `set_property`/`unset_property`.
  - Individual datastream: `send_individual`.
  - Object datastream: `send_object`.
