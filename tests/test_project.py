...
class UnitTests(unittest.TestCase):
    def setUp(self):
        self.device = Device(
            "device_id", "realm", "credentials_secret", "pairing_base_url", os.path.curdir
        )
    ...
    def test_device_get_qos0(self):
        ...
        self.assertIs(
            self.device._get_qos(interface_definition_unreliable["interface_name"]),
            0,
    ...
    def test_device_get_qos1(self):
        ...
        self.assertIs(
            self.device._get_qos(interface_definition_guaranteed["interface_name"]),
            1,
    ...
    def test_device_get_qos2(self):
        ...
        self.assertIs(
            self.device._get_qos(interface_definition_unique["interface_name"]),
            2,
