...
We will explain how the SDK APIs can be used to create a device, connect to Astarte and transmit
data with ease.
...
If you don't have access to an Astarte instance you can easily set up one following our Astarte
quick instance guide.
...
In the snippets below we will assume you registered a device with the ID `MFVgjjP2Tt6RbT_wKOI0VA`.
...
## Installin the Astarte device SDK for Python
...
astarte_pairing_base_url = "http://api.astarte.localhost/pairing"
realm = "test"
device_id = "MFVgjjP2Tt6RbT_wKOI0VA"
